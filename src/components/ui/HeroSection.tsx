...
export function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden h-[600px] lg:h-[900px] bg-primary">
      ...
      <div className="container mx-auto px-4 py-20 sm:py-32 md:py-40 lg:py-48 relative z-10 h-full flex items-center">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-accent/20 border border-accent/40 px-4 py-2 rounded-full text-white text-sm font-semibold mb-8 font-body">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start">
            <button
              ...
              className="group px-8 py-4 bg-accent text-white rounded-xl font-bold text-lg shadow-lg hover:bg-accent-dark transition-all duration-300 hover:scale-105 flex items-center gap-2 font-body"
            >
