...
export function PaymentStep({
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-heading font-semibold text-primary">Payment Method</h3>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-heading font-medium text-primary mb-1">
                    {method.name}
                  </h4>
      ...
      {selectedMethod === PAYMENT_METHODS.CARD && (
        <div className="bg-gray-50 p-6 rounded-lg">
          <h4 className="font-heading font-medium mb-4 text-primary">Card Details</h4>
          <div className="space-y-4">
            <div>
      ...
      <div className="flex gap-4">
        <button
          onClick={onBack}
          className="flex-1 border border-gray-300 py-3 px-4 rounded-lg hover:bg-gray-50 font-medium font-body text-primary"
        >
          Back to Address
        </button>
